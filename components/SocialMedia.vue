<template>
  <div class="flex justify-center py-10 [&>span]:mx-1">
    <!-- Behance -->
    <span class="[&>svg]:h-7 [&>svg]:w-7 [&>svg]:fill-[#1769ff]">
    ...
    <!-- Pinterest -->
    <span class="[&>svg]:h-7 [&>svg]:w-7 [&>svg]:fill-[#e60023]">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
        <!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc. -->
        <path
    ...
    <!-- Stack overflow -->
    <span class="[&>svg]:h-7 [&>svg]:w-7 [&>svg]:fill-[#f48024]">
    ...
    <!-- Dribbble -->
    <span class="[&>svg]:h-7 [&>svg]:w-7 [&>svg]:fill-[#ea4c89]">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="currentColor"
        viewBox="0 0 512 512"
    ...
    <!-- Reddit -->
    <span class="[&>svg]:h-7 [&>svg]:w-7 [&>svg]:fill-[#ff4500]">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="currentColor"
        viewBox="0 0 512 512"
